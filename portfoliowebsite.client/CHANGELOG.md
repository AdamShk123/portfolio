...
- Create Angular project with ng: `ng new portfoliowebsite.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`portfoliowebsite.client.esproj`).
